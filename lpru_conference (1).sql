...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2018 at 08:44 AM
...
CREATE TABLE `course_order` (
  ...
  `cert_id` int(3) DEFAULT NULL,
  `time_stamp` datetime NOT NULL,
  `order_log` varchar(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `course_order` (`order_id`, `per_id`, `registration_id`, `cert_id`, `time_stamp`, `order_log`) VALUES
(1, 1, 10, NULL, '2018-04-26 03:02:58', NULL),
(2, 1, 15, NULL, '2018-04-26 19:22:27', NULL),
(3, 2, 10, NULL, '2018-04-28 15:02:36', NULL),
(4, 2, 15, NULL, '2018-04-28 15:02:36', NULL),
(26, 3, 10, NULL, '2018-04-29 01:38:53', NULL),
(28, 3, 15, NULL, '2018-04-29 01:38:53', NULL);
...
(3, '2018-04-29', '2018-04-29', '08:45:00', '20:45:00', 0, 30, 1, 1, 0);
...
(10, 2, 'นาย', 'ชยากร', 'แก้ววงศ์', 'ชาย', '806 moo 3 wiang', 'chiang sean', 'chiang sean', 'chiang rai', 'whitecat.chayakorn@gmail.com', 'วิศวกรรมซอฟต์แวร์', NULL, 'มหาวิทยาลัยราชภัฏลำปาง', '57122660106', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92'),
(15, 0, 'นาย', 'ชุติพงษ์', 'หาญยุทธ', 'male', '-', '-', '-', '-', '-', 'วิศวกรรมซอฟต์แวร์', NULL, 'มหาวิทยาลัยราชภัฏลำปาง', '57122660107', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92');
...
--
ALTER TABLE `period`
  MODIFY `per_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
