...
export default class ReactConfirmModalDialog extends Component {
    ...
    state = {
        ...
        //ใช้งาน PropTypes เป็นการเช็คค่า Props ที่ส่งเข้ามาว่าตรงตามที่เราก􀄞ำหนดหรือไม่
        //เหมือนการตรวจสอบการท􀄞ำงานของโปรแกรมเพื่อไม่ให้เกิดข้อผิดพลาด
        static propTypes = {
        type: PropTypes.string, //รับค่าตัวข้อความ warning, info
        show: PropTypes.bool, //รับค่า true , false เพื่อก􀄞ำหนดว่าจะแสดง Modal หรือไม่
